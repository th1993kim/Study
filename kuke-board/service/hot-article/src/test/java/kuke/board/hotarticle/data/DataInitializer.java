...
public class DataInitializer {
    ...
    RestClient likeArticleServiceClient = RestClient.create("http://localhost:9002");
    RestClient viewArticleServiceClient = RestClient.create("http://localhost:9003");
    ...
    void createViewCount(Long articleId, long viewCount) {
        while(viewCount-- > 0) {
            viewArticleServiceClient.post()
